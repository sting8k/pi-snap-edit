...
export default function (pi: ExtensionAPI) {
  ...
  pi.registerTool({
    ...
    promptGuidelines: [
      ...
      "Use exact literal target text only; no regex. Use \\n for multi-line targets and replacements; targets are also matched after unescaping JSON-style sequences; set matchMode=trim when indentation/trailing whitespace may differ (original indentation is preserved on write).",
